...
module Faraknight
  # Main Faraknight::Multipart module.
  module Multipart
    Faraknight::Request.register_middleware(multipart: Faraknight::Multipart::Middleware)
  end

  # Aliases for Faraknight v1, these are all deprecated and will be removed in v2 of this middleware
